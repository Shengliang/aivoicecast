...
import { getUserDesignDocs, deleteCommentFromChannel } from '../services/firestoreService'; // Reusing delete helper? No, we likely need specific delete logic or just hide it.
import { FileText, Calendar, ArrowRight, Loader2, MessageSquare, Trash2 } from 'lucide-react';
    ...
    <div className="space-y-6 animate-fade-in-up">
      ...
      {loading ? (
        ...
        <div className="py-12 text-center text-slate-500 bg-slate-900/30 rounded-xl border border-dashed border-slate-800">
          ...
          <p className="text-xs mt-2">Generate them from your discussion transcripts.</p>
        </div>
      ) : (
            ...
            >
              <div>
                ...
                <p className="text-xs text-slate-400 mb-4 line-clamp-2">
                   Linked to Lecture ID: {doc.lectureId}
                </p>
              </div>
